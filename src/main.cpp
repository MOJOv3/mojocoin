...
#if defined(NDEBUG)
# error "Mojocoin cannot be compiled without assertions."
#endif
...
{   
	if (pindexBest->nHeight == 1){
        int64_t nSubsidy = 12000000 * COIN;
...
{
    int64_t nSubsidy = FIXED_POS_REWARD;
    return nSubsidy + nFees;
}
...
#ifdef ENABLE_WALLET
// mojocoin: attempt to generate suitable proof-of-stake
