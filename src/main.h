...
static const int64_t FIXED_POS_REWARD = 2 * COIN;

inline bool IsProtocolV2(int nHeight) {
    return TestNet() || nHeight > 0; // Start new mojo chain using ProtocolV2
}
inline bool IsProtocolV3(int64_t nTime) {
    return TestNet() || nTime > 0; // Start new mojo chain using ProtocolV3
}
